...
# General info
declare Dataset="enigmatest" # Replace enigmatest with the name of your dataset
...
declare ANALYSISDIR="/cluster/projects/p697/users/idaeson/CNVCalling/enigmacnv/shuffletest/" # replace with the full path for the Analysis-folder on your computer/server
...
declare Chip="Illumina_GSA" # genotyping chip: Note - if your dataset is Affymetrix, make sure to put in "Affy6" - otherwise the script will not run appropriately
declare Chipversion="v2" # version of chip (if applicable) [set as NA if non-applicable]
...
declare IlluminaReport="" # name of your Illumina-Final Report-file
declare SNPPosFile="enigmacnvtest_SNP_Map_hg19.txt" 
...
declare PFB="enigmacnvtest_${genomeversion}" # ONLY USER-INPUT for those with <300 individuals -  replace with the correct PFB & GCMODEL (note without extensions) 
...
declare SOFTWAREDIR="/cluster/projects/p697/users/idaeson/CNVCalling/software/" # USER-INPUT (enigmacnv.sif-placement) OBS - for the majority of cohorts this will be the ${ANALYSISDIR}. Can be replaced with absolut path, e.g. /cluster/projects/p697/users/idaeson/CNVCalling/software/"
